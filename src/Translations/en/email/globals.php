...
return [
    ...
    'user_new_ticket'   => '<b style="color: #fa4f10;">:user</b> has created this ticket.',
    'closed_ticket'     => '<b style="color: #fa4f10;">:user</b> has closed this ticket.',
    'updated_status'    => '<b style="color: #fa4f10;">Help Desk</b> has changed this ticket status.',
    'updated_agent'     => '<b style="color: #fa4f10;">HD Manager</b> has assigned this ticket to you.',

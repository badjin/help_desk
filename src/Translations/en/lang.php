...
// tickets/create
  ...
  'create-ticket-brief-issue'        => 'A brief of your issue',
  ...
  'create-ticket-change-list'        => 'Status change',
  ...
  'show-ticket-modal-complete-blank-intervention-check' => 'Leave blank Log action',
  'show-ticket-complete-blank-intervention-alert'       => 'To complete the ticket you must confirm that you leave log action field blank',
  ...
  'show-ticket-add-com-check-intervention' => 'Append this text in Log action field (visible by user)',
  'show-ticket-add-com-check-resolve'      => 'Complete this ticket and apply the status',
  'add-comment-confirm-blank-intervention' => 'The "Log action" field is empty. Would you want to close ticket anyway?',

  'edit-internal-note-title'         => 'Edit internal note',
  'show-ticket-edit-com-check-int'   => 'Add text to the Log action field',
...
// Ticket search form
   ...
   'searchform-help-any_text_field'  => 'Find in any text field in: Subject, Description, Log action, Comments or attachment fields',

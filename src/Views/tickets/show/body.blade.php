    ...
    <div id="ticket-body" class="card-body">
		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-9 col-md-8">
				<div class="col-md-12">
					<div class="card" style="height: 100%; margin-left: -15px; margin-right: -23px">
						<div class="card-body">
							<div>
...
{{--						<div class="card" style="height: 100%; margin-left: -15px; margin-right: -7px">--}}
{{--							<div class="card-body">--}}
{{--								<div>--}}
{{--									<b>{{ trans('panichd::lang.description') }}</b>--}}
{{--								</div>--}}
...
{{--				</div>--}}
		...
		<div style="margin: 1em 0em 0em 0em;">
			...
			@elseif($ticket->completed_at && $reopen_perm == 'yes')
				{!! link_to_route($setting->grab('main_route').'.reopen', trans('panichd::lang.reopen-ticket'), $ticket->id, ['class' => 'btn btn-light btn-default']) !!}
			@endif

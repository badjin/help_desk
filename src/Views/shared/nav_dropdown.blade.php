<ul class="dropdown-menu">
	...
	<a class="dropdown-item {!! $tools->fullUrlIs(action('\PanicHD\PanicHD\Controllers\QnasController@index')) || Request::is($setting->grab('admin_route').'/indicator*') ? 'active' : '' !!}" href="{{ action('\PanicHD\PanicHD\Controllers\QnasController@index') }}" title="{{ trans('panichd::admin.nav-qnas-title') }}">
		{{ trans('panichd::admin.nav-qnas') }}
	</a>

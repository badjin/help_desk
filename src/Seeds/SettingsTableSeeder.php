...
class SettingsTableSeeder extends Seeder
{
    ...
    public function getDefaults()
    {
        return [
            ...
            */
            'email.account.name'    => 'Support Team',
            'email.account.mailbox' => 'support@adapto.com.au',
...
//            'admin_ids' => [1],
            ...
            */
             ...
             */
            'attachments_ticket_max_size' => '10',
            /*
            ...
            */
             ...
             */
            'close_ticket_perm' => ['owner' => 'no', 'agent' => 'yes', 'admin' => 'yes'],
            /*
             * Reopen Ticket Perm: Who has a permission to reopen tickets
             * Default: ['owner' => 'yes', 'agent' => 'yes', 'admin' => 'yes']
             */
            'reopen_ticket_perm' => ['owner' => 'no', 'agent' => 'yes', 'admin' => 'yes'],
            /*
